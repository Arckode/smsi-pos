...
<body>
    ...
    <div class="page-container w-[210mm] h-[297mm] bg-white p-[8mm] text-[8px] text-black shadow-2xl relative overflow-hidden box-border flex flex-col leading-tight">
        ...
        <div class="border-[1px] border-black">
            ...
            <div class="bg-red-600 text-white font-bold px-1 text-center text-[9px] uppercase mb-1 border border-black shrink-0">
                I. DATA PESERTA
            </div>
            ...
            <div class="flex flex-col gap-[3px] shrink-0">
                <div class="flex items-center">
                    <div class="w-[130px] shrink-0 leading-none">
                        ...
                        <span class="text-[7px] block italic" style="font-style: italic; margin-left: 10px">(sesuai KTP)</span>
                    </div>
                    <div class="flex-1">{!! renderSpajBoxes($data->nama_lengkap ?? '', 52) !!}</div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1 flex items-center gap-2">
                        {!! renderSpajBoxes($data->tempat_lahir ?? '', 52) !!}
                    </div>
                </div>
                <div class="flex items-center">
                    <div class="w-[130px] shrink-0 font-bold"></div>
                ...
                <div class="flex items-center">
                    <div class="w-[130px] shrink-0 leading-none">
                        <span class="font-bold block" style="margin-left: 9px">Nomor Bukti Identitas</span>
                    </div>
                    <div class="flex-1 flex items-center gap-2">
                        {!! renderSpajBoxes($data->nomor_identitas ?? '', 52) !!}
                    </div>
                </div>
    
                <div class="flex items-center">
                    <div class="w-[130px] shrink-0 font-bold">5. No. NPWP <span class="font-normal">(wajib diisi)</span></div>
                    <div class="flex-1">{!! renderSpajBoxes($data->npwp ?? '', 52) !!}</div>
                </div>
                ...
                <div class="flex items-center">
                    <div class="w-[130px] shrink-0 font-bold">7. Warga Negara</div>
                    <div class="flex-1 flex justify-between pr-4">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1 flex justify-between pr-2">{!! renderSpajBoxes($data->agama ?? '', 52) !!}</div>
                </div>
                <div class="flex items-center">
                    <div class="w-[130px] shrink-0 font-bold">9. Pendidikan</div>
                ...
                <div class="flex items-start mt-0.5">
                    ...
                    <div class="flex-1 flex flex-col gap-[3px]">
                        {!! renderSpajBoxes($data->alamat_rumah ?? '', 52) !!}
                        <div class="flex items-center gap-4">
                ...
                <div class="flex items-start mt-0.5">
                    ...
                    <div class="flex-1 flex flex-col gap-[3px]">
                        {!! renderSpajBoxes($data->alamat_korespondensi ?? '', 52) !!}
                        <div class="flex items-center gap-4">
                ...
                <div class="flex items-start mt-0.5">
                    ...
                    <div class="flex-1 flex flex-col gap-[3px]">
                        {!! renderSpajBoxes($data->pekerjaan ?? '', 52) !!}
                    </div>
                </div>
                <div class="flex items-center">
                    <div class="w-[118px] shrink-0 font-bold" style="margin-left: 12px">Bagian</div>
                    <div class="flex-1">{!! renderSpajBoxes($data->pekerjaan_bagian ?? '', 52) !!}</div>
                </div>
                <div class="flex items-center">
                    <div class="w-[118px] shrink-0 font-bold" style="margin-left: 12px">Aktifitas yang dilakukan</div>
                    <div class="flex-1">{!! renderSpajBoxes($data->pekerjaan_aktifitas ?? '', 52) !!}</div>
                </div>
                <div class="flex items-center">
                    <div class="w-[118px] shrink-0 font-bold" style="margin-left: 12px">Nama Perusahaan </div>
                    <div class="flex-1">{!! renderSpajBoxes($data->nama_perusahaan ?? '', 52) !!}</div>
                </div>
                <div class="flex items-center">
                    <div class="w-[118px] shrink-0 font-bold" style="margin-left: 12px">Jenis Usaha</div>
                    <div class="flex-1">{!! renderSpajBoxes($data->jenis_usaha ?? '', 52) !!}</div>
                </div>
                <div class="flex items-start mt-0.5">
                    <div class="w-[118px] shrink-0 font-bold" style="margin-left: 12px">Alamat Kantor</div>
                    <div class="flex-1 flex flex-col gap-[3px]">
                        {!! renderSpajBoxes($data->alamat_kantor ?? '', 52) !!}
                        <div class="flex items-center gap-4">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1">{!! renderSpajBoxes($data->no_hp ?? '', 14) !!}</div>
                </div>
                <div class="flex items-center">
                    <div class="w-[130px] shrink-0 font-bold">14. Alamat E-mail</div>
                    <div class="flex-1">{!! renderSpajBoxes($data->email ?? '', 52) !!}</div>
                </div>
