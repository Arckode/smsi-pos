                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">Affiliasi lists</h6>
                                <p class="text-sm">Informasi Affiliasi terdaftar di system</p>
                            </div>
                        ...
                        <div class="table-responsive p-0">
                            ...
                            <table v-else ref="userTable"
                                ...
                                <thead class="bg-gray-100">
                                    <tr>
                                        <th class="text-sm font-weight-semibold opacity-7">Nama Affiliasi<br>Kota</th>
                                        <th class="text-sm font-weight-semibold opacity-7">Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="item in collection.affiliasi.data" :key="item.id">
                                        ...
                                        <td class="align-middle text-lg">
                                            <a class="btn btn-sm mb-0" @click="changeStatus(item.id)"
                                                :class="item.status ? `btn-success` : `btn-secondary`">{{
                                                    item.status ? 'Active' : 'Inactive' }}</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="border-top py-3 px-3 d-flex align-items-center flex-wrap">
                            <div class="d-flex flex-column">
                                <p class="font-weight-semibold mb-0 text-dark text-sm">Halaman {{
                                    meta.page.affiliasi.current_page }} dari {{ meta.page.affiliasi.last_page
                                    }}
                                </p>
                            ...
                            <div class="ms-auto">
                                <button v-for="(link, index) in collection.affiliasi.links"
                                    v-on:click="changePageAffiliasiList(link.url)" class="btn btn-sm btn-white mb-0"
                                    ...
                                    <span v-else-if="index === collection.affiliasi.links.length - 1">
...
export default {
    ...
    methods: {
        ...
        async fetchUserList() {
            ...
            let endpoint = `${BASEURL}/api/affiliasi`;
            try {
                ...
                this.meta.page.affiliasi.current_page = this.collection.affiliasi.current_page
                this.meta.page.affiliasi.last_page = this.collection.affiliasi.last_page
                this.loadContent = false
                this.initDataTable();
            } catch (error) {
