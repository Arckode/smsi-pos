                    ...
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            ...
                            <div class="ms-auto d-flex">
                                <button v-if="canCreateBook" @click.prevent="addNasabah"
                    ...
                    <div class="card-body px-0 py-0">
                        ...
                        <div class="table-responsive p-0">
                            ...
                            <div v-else-if="accessDenied" class="text-center p-5">
                                <h6 class="text-danger">Anda tidak memiliki izin untuk melihat data pada halaman ini.</h6>
                            </div>
                            <h6 v-else-if="collection.nasabah && collection.nasabah.data.length == 0"
...
export default {
    ...
    methods: {
        ...
        canPerformAction(action) {
            console.log('Checking access for action:', action, this.bookSubmoduleAccess?.actions?.includes(action) ?? false);
            return this.bookSubmoduleAccess?.actions?.includes(action) ?? false;
        },
    },
    computed: {
        bookSubmoduleAccess() {
            return this.getSubmoduleAccessByUrl('/books');
        },
