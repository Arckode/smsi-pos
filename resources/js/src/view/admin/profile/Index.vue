            ...
            <div class="row">
                <div class="col-auto">
                    <div v-if="!isEditing"
                        ...
                        <img :src="user.picture ? asset(`/profile_pictures/${user.picture}`) : asset('/profile_pictures/default.jpg')"
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pb-1 text-sm">
                                <div class="input-group flex-nowrap" style="align-items: center;">
                                    <span class="input-group-text" id="addon-wrapping" style="width: 90px;">Role</span>
                            ...
                            <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pb-1 text-sm">
                                ...
                                <div class="input-group flex-nowrap pb-2" style="align-items: center;"
                                    ...
                                    <input v-bind:type="showPassword ? 'text' : 'password'" class="form-control"
                                        aria-label="Password" v-model="editedUser.password">
...
export default {
    ...
    methods: {
        ...
        async confirmSave() {
            if (this.changePassword && this.editedUser.password == null) {
                Swal.fire({
                    icon: "error",
                    title: "Oops...",
        ...
        async toggleUpdate() {
            let endpoint = `${BASEURL}/api/auth/update/${this.user.id}`;
            try {
                let userData = {
                    user: this.editedUser,
                    image: this.selectedFile
                };
                let response = await axios.post(endpoint, userData, {
                    headers: {
